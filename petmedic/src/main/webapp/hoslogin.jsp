	...
	<div id="logoNmianMenu">
		...
		<div id="mainMenuListUlDiv">
			<ul class="nav mainMenuList">
				...
				<li><a href="about.jsp" class="nav-link petmedicnav-link"> <b id="navb">펫메딕소개</b></a></li>
...
<!-- 모달로그인			 -->
    ...
    <div class="modal" id="login">
        ...
        <br><br>      
            <button class="btn btn btn-lg btn-success btn-block" id="navbarloginbt2" onclick="userLoginCheck()" type="button">로그인</button>
